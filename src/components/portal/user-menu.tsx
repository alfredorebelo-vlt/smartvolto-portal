...
export function UserMenu({ onNav }: { onNav?: (id: string) => void  }) {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open ? (
        <div className="absolute bottom-full left-0 right-0 mb-2 overflow-hidden rounded-xl border border-[var(--border)] bg-[var(--card)] shadow-lg">
          <button
            type="button"
